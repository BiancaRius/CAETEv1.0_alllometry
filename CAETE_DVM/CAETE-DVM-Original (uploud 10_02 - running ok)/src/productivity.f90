...
contains
  ...
  subroutine prod(p, dt,light_limit,catm,temp,ts,p0,w,ipar,rh,emax,cl1_prod,&
...
! rate (molCO2/m2/s)
    ...
    call photosynthesis_rate(p,ca1_prod, cl1_prod, catm,temp,p0,ipar,light_limit,c4_int,n2cl,&
